## The Meaning of `<T>` in TypeScript
...
Nor living object wandering through thy code;
But rather, promise of a form one day,
A vessel waiting for a type bestowed.

When thou dost call parseBody<WebhookPayload>,
Lo! T becomes the payload thou declarest;
